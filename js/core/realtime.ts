...
function iniciarRealtime(rpgId: string){
 ...
 function conectar(){
   ...
   ws.onopen=()=>{
     ...
     for(const t of todos) {
       if (_pausado && _PAUSABLE_TOPICS.has(t as string)) continue; // P2P ativo: não re-inscrever tópicos voláteis
       _doJoin(t as string);
     }
 ...
 function _agendarReconexao(wsFechado?: any){
...
Object.defineProperty(globalThis, "iniciarRealtime", { configurable: true, writable: true, value: iniciarRealtime });
Object.defineProperty(globalThis, "fecharRealtime", { configurable: true, writable: true, value: fecharRealtime });
Object.defineProperty(globalThis, "realtimeBroadcast", { configurable: true, writable: true, value: realtimeBroadcast });
