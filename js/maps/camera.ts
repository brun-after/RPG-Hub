...
Object.defineProperty(globalThis, "_TIPO_ANIM_CLASS", { configurable: true, get: () => _TIPO_ANIM_CLASS });
Object.defineProperty(globalThis, "animarAtaque3Camadas", { configurable: true, writable: true, value: animarAtaque3Camadas });
Object.defineProperty(globalThis, "_dispararParticulasToken", { configurable: true, writable: true, value: _dispararParticulasToken });
Object.defineProperty(globalThis, "_origMRTokens7", { configurable: true, get: () => _origMRTokens7 });
Object.defineProperty(globalThis, "_aplicarPulsoZonas", { configurable: true, writable: true, value: _aplicarPulsoZonas });
Object.defineProperty(globalThis, "_verificarProximidadeZonas", { configurable: true, writable: true, value: _verificarProximidadeZonas });
Object.defineProperty(globalThis, "_aplicarIconesLootTokens", { configurable: true, writable: true, value: _aplicarIconesLootTokens });
Object.defineProperty(globalThis, "_verificarMapaIsoLegado", { configurable: true, writable: true, value: _verificarMapaIsoLegado });
Object.defineProperty(globalThis, "snapParaCelula", { configurable: true, writable: true, value: snapParaCelula });
Object.defineProperty(globalThis, "_origMapaRenderCanvas7", { configurable: true, get: () => _origMapaRenderCanvas7 });
Object.defineProperty(globalThis, "animarAtaque", { configurable: true, writable: true, value: animarAtaque });
Object.defineProperty(globalThis, "_animProjetil", { configurable: true, writable: true, value: _animProjetil });
Object.defineProperty(globalThis, "_animOnda", { configurable: true, writable: true, value: _animOnda });
Object.defineProperty(globalThis, "_animExplosao", { configurable: true, writable: true, value: _animExplosao });
Object.defineProperty(globalThis, "_animRaio", { configurable: true, writable: true, value: _animRaio });
Object.defineProperty(globalThis, "_animGerarZigzag", { configurable: true, writable: true, value: _animGerarZigzag });
Object.defineProperty(globalThis, "_animAura", { configurable: true, writable: true, value: _animAura });
Object.defineProperty(globalThis, "_animAuraGuerreiro", { configurable: true, writable: true, value: _animAuraGuerreiro });
Object.defineProperty(globalThis, "_animCorte", { configurable: true, writable: true, value: _animCorte });
Object.defineProperty(globalThis, "_animBolaEnergia", { configurable: true, writable: true, value: _animBolaEnergia });
