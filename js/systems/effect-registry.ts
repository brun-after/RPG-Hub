...
(function () {
  ...
  const TYPES = [
    // ── Negativos / alvo (não elegíveis para orbe) ───────────────────────────
    {
      ...
      detect: ef => !!ef.dot_formula,
      duracaoDe: ef => ef.dot_turnos,
      campos: ['dot_formula', 'dot_turnos', 'dot_variante'],
    },
    {
      id: 'stun', label: 'Atordoar', icone: '🌀', cor: '#9b59b6',
      isStatus: true, positivo: false, orbEligible: false,
      detect: ef => ef.tipo === 'stun',
      duracaoDe: ef => ef.duracao_turnos,
      campos: [],
    },
    {
      id: 'silence', label: 'Silenciar', icone: '🤐', cor: '#1a0028',
      isStatus: true, positivo: false, orbEligible: false,
      detect: ef => ef.tipo === 'silence',
      duracaoDe: ef => ef.duracao_turnos,
      campos: [],
    },
    {
    ...
    // ── Positivos / usuário (candidatos a orbe) ──────────────────────────────
    {
      ...
      detect: ef => !!ef.hot_formula,
      duracaoDe: ef => ef.hot_turnos,
    ...
    },
    {
      ...
      isStatus: true, positivo: true,
      detect: ef => ef.boost_dano != null && ef.boost_dano !== 0,
      duracaoDe: ef => ef.boost_dano_turnos,
    ...
    },
    {
      ...
      isStatus: true, positivo: true,
      detect: ef => !!ef.rec_atributo || (!!ef.rec_formula && ef.tipo == null),
      duracaoDe: ef => ef.rec_turnos,
    ...
    },
    {
      ...
      isStatus: true, positivo: true,
      detect: ef => !!ef.imune_dano,
      duracaoDe: ef => ef.imune_dano_turnos,
    ...
    },
    {
      ...
      isStatus: true, positivo: true,
      detect: ef => ef.tipo === 'ab_cd_reduzir',
      duracaoDe: ef => ef.duracao_turnos,
    ...
    },
    {
      ...
      isStatus: true, positivo: true,
      detect: ef => ef.tipo === 'ab_dano_buff',
      duracaoDe: ef => ef.duracao_turnos,
    ...
    },
    {
      ...
      isStatus: true, positivo: true,
      detect: ef => ef.tipo === 'ab_multi_alvo',
      duracaoDe: ef => ef.duracao_turnos,
    ...
    },
    {
      ...
      isStatus: true, positivo: true,
      detect: ef => ef.tipo === 'ab_alcance_buff',
      duracaoDe: ef => ef.duracao_turnos,
    ...
    },
    {
      ...
      isStatus: true, positivo: false, orbEligible: false,
      detect: ef => ef.tipo === 'necromante',
      duracaoDe: ef => ef.duracao_turnos, campos: ['cor_dominado'],
    },
    {
      id: 'rastro_persona', label: 'Rastro Persona', icone: '🐾', cor: '#5ee09a',
      isStatus: false, positivo: true, orbEligible: false,
      detect: ef => ef.tipo === 'rastro_persona',
      duracaoDe: ef => ef.duracao_turnos, campos: ['rastro_formula', 'rastro_cor'],
    },
    {
      id: 'rastro_anima', label: 'Rastro Anima', icone: '☄', cor: '#5ee09a',
      isStatus: false, positivo: true, orbEligible: false,
      detect: ef => ef.tipo === 'rastro_anima',
      duracaoDe: ef => ef.duracao_turnos, campos: ['rastro_formula', 'rastro_cor'],
    },
    {
      id: 'invocar_catalogo', label: 'Invocação do catálogo', icone: '🐺', cor: '#b07ef0',
      isStatus: false, positivo: true, orbEligible: false,
      detect: ef => ef.tipo === 'invocar_catalogo',
      duracaoDe: ef => ef.invocar_duracao_turnos,
