...
Object.defineProperty(globalThis, "combateBroadcast", { configurable: true, writable: true, value: combateBroadcast });
Object.defineProperty(globalThis, "combateReceberBroadcast", { configurable: true, writable: true, value: combateReceberBroadcast });
Object.defineProperty(globalThis, "_ANIM_SID", { configurable: true, get: () => _ANIM_SID });
Object.defineProperty(globalThis, "animBroadcast", { configurable: true, writable: true, value: animBroadcast });
Object.defineProperty(globalThis, "animReceberBroadcast", { configurable: true, writable: true, value: animReceberBroadcast });
Object.defineProperty(globalThis, "_atkRodarAnimacao", { configurable: true, writable: true, value: _atkRodarAnimacao });
Object.defineProperty(globalThis, "resolverTokenEl", { configurable: true, writable: true, value: resolverTokenEl });
Object.defineProperty(globalThis, "_animCriarCanvas", { configurable: true, writable: true, value: _animCriarCanvas });
Object.defineProperty(globalThis, "_animCentro", { configurable: true, writable: true, value: _animCentro });
Object.defineProperty(globalThis, "_animHexToRgb", { configurable: true, writable: true, value: _animHexToRgb });
